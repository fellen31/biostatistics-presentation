...
- With a linear relationship between x and y
- Two study groups 
...
- Intercept is the value of y when all x = 0

- Median score at week 0 for the Standard group
...
# Comparison to including outlier
...
# Model assumptions: Linearity & homogeneity of residuals variance
...
```
---
# Alternative analysis: longitudinal data 
