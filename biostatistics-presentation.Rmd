...
> "A <b>randomized trial</b> evaluated a <b>new therapy program</b> designed to help patients recover from a stroke, comparing it to a standard program. 

> Patients were <b>evaluated at baseline</b> (week 0), and for <b>7 consecutive weeks</b>, using the Barthelindex. This score ranges from 0 to 100, higher scores indicating better functional ability". 
...
- One individual in the experimental group with values of 100 across all weeks
...
- Two study groups 
- Interested in the interaction between week and group
...
- Intercept: the value of y if all the x's are 0 

- GroupExperimental: 10.5 lower estimated mean score than standard group (at week 0?)

- Week: Standard group score increases 4.33/week

- Interaction term: Experimental group score increases with 4.3+2.89 per week
...
.pull-right[
``` {r, echo=FALSE, fig.width=6,fig.height=2, dev='png', dpi=300, warning=FALSE}
...
- Linear relationship between x and y (residuals should be as close to 0 as possible)
...
- Likely to be similar for each individual (serial correlation)
